...
// div.head:
// must include <a href="http://www.w3.org/"><img height="48" width="72" alt="W3C" src="http://www.w3.org/Icons/w3c_home"/></a>
//  with absolute URLs
...
// XXX Add a NOVALIDATE option somehow so we can run tests when the validator is too slow
// XXX reënable these with tests
// XXX make tests run per rule rather than per profile
