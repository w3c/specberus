...
/**
 * Extract message to give description for errors/warnings.
 *
 * @param {Object} data2 - name and key to match message in L10n.
 */

const getErrorMessage = function (...data2) {
    var data = Object.assign({}, ...data2);
    return data.name && { detailMessage: l10n.assembleData(null, data.name, data.key, data.extra).message };
};
...
const processRequest = function(req, res) {
    ...
    if ('/api/version' === req.path) {
        ...
        if (validate && 'auto' === options.profile) {
            ...
            handler = new Sink(function(...data) {
                ...
                if (errors.length > 0)
                    ...
                    handler2 = new Sink(function (...data2) {
                        errors2.push(Object.assign({}, ...data2, getErrorMessage(...data2)));
                    }, function() {
                        sendJSONresult(errors2, warnings2, info2, res, meta);
                    }, function(...data2) {
                        warnings2.push(Object.assign({}, ...data2, getErrorMessage(...data2)));
                    }, function(...data2) {
                        info2.push(Object.assign({}, ...data2, getErrorMessage(...data2)));
                    });
            ...
            v = new validator.Specberus();
            handler = new Sink(function(...data) {
                errors.push(Object.assign({}, ...data, getErrorMessage(...data)));
            }, function(data) {
                sendJSONresult(errors, warnings, info, res, data.metadata);
            }, function(...data) {
                warnings.push(Object.assign({}, ...data, getErrorMessage(...data)));
            }, function(...data) {
                info.push(Object.assign({}, ...data, getErrorMessage(...data)));
            });
            handler.on('exception', function(data) {
                sendJSONresult([data.message ? data.message : data], [], [], res, {});
            });
