...
const serveStraight = function(req, res) {
    ...
    res.render(fragment, {version: version, nav: nav, title: fragment});
};
...
const handleWIP = function(req, res) {
    res.render('wip', {version: version, nav: nav, title: 'coming soon'});
};
...
const handleWrongPage = function(req, res) {
    res.render('error', {version: version, nav: nav, title: "whut?"});
};
...
const setUp = function(app) {
    ...
    app.get('/', function(req, res) {
        res.render('index', {version: version, nav: nav});
    });

    app.get('/doc', function(req, res) {
        res.render('doc', {version: version, nav: nav, title: 'documentation', profiles: listProfiles()});
    });

    app.get('/doc/rules', function(req, res) {
        res.render('doc/rules', {version: version, nav: nav, title: 'publication rules', content: retrieveProfile(req.query)});
    });

    app.get('/check', function(req, res) {
        res.render('check', {version: version, nav: nav, title: 'checker', interactive: true});
    });
