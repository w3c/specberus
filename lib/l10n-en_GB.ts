export const messages = {
    ...
    'generic.shortname.not-found':
        'The shortname of the document could not be resolved from the &ldquo;This version&rdquo; &lt;dt&gt; in the headers of the document. This may cause further errors downstream.',
    // headers/logo
    ...
    'headers.dl.editor-missing-id':
        'Missing `data-editor-id` or `data-editor-github` attribute for editor(s): ${names}.',
    'headers.dl.editor-github-failed':
        'GitHub request failed for `data-editor-github="${name}"`.',
    'headers.dl.editor-github-unresolvable':
        '`data-editor-github` value could not be resolved: ${names}.',
    ...
    'headers.translation.found':
        "Translations link <a href='${link}'>found</a>.",
    'headers.translation.not-found': 'Translations link not found.',
    'headers.translation.not-recommended-link':
        'The recommended translation link is not used (<code>https://www.w3.org/Translations/?technology=[shortname]</code>)',
    // headers/div-head
    ...
    'structure.neutral.neutral':
        'Please make sure the expressions in document are neutral, "${words}" found in document. Check <a href="https://www.w3.org/guide/manual-of-style/#inclusive">W3C Manual of Style</a> for more information.',
    // style/sheet
    'style.sheet.last':
    ...
    'metadata.editor-ids.editor-github-failed':
        'GitHub request failed for `data-editor-github="${name}"`.',
    'metadata.editor-ids.editor-github-unresolvable':
        '`data-editor-github` value could not be resolved: ${names}.',
