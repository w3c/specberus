...
<<<<<<< HEAD
=======
>>>>>>> bc4ccbb... L10n: messages split into two tentative languages.
=======
,   selectors: require("./l10n-wording").selectors
,   wording: require("./rules")
>>>>>>> 71c7466... Progress on the new documentation architecture.
>>>>>>> architectural changes about pubrules rules diplay
=======
>>>>>>> L10n: messages split into two tentative languages.
};
