...
var messages = {
    ...
    ,   "headers.subm-logo.not-found":  "Failed to include logo in link with absolute URLs for ${type} Submission."
        // headers/hr
    ,   "headers.hr.not-found":     "No <hr> at the end of or right after div.head."
    ,   "headers.hr.duplicate":     "Duplicate <hr> at the end of and right after div.head."
        // headers/h2-status
    ...
    ,   "sotd.status.no-mention":   "SotD does not mention that this is a ${status}."
        // sotd/lc-end
    ,   "sotd.lc-end.no-sotd":      "No SotD section."
    ,   "sotd.lc-end.not-found":    "No Last Call end date found."
        // sotd/cr-end
    ...
    ,   "sotd.processDocument.not-found":         "According to your selection, the document must mention the governing process: ${process}"
        // sotd/implementation
    ,   "sotd.implementation.candidate":    "Found link to a preliminary interoperability/implementation report: “${text}” [${url}]."
    ,   "sotd.implementation.no-report":    "Found a statement about a (missing) preliminary interoperability/implementation report: “…${text}…”."
	...
	// heuristic/group
    ,   "heuristic.group.candidate":          "The group might be the “${name}” [${url}]."
