...
exports.check = function (sr, done) {
    ...
    if (docDate) {
        ...
        var month = (docDate.getMonth() + 1).toString();
        var day = docDate.getDate().toString();
        var formattedDate =
            year +
        ...
        var req = sua.get(endpoint).set('User-Agent', ua);
