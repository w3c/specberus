...
export function check(sr, done) {
    ...
    if (sotd) {
        ...
        const pCorSection = sotd.querySelector('p.correction.proposed');
        const pAddSection = sotd.querySelector('p.addition.proposed');
        const cCorSection = sotd.querySelector('p.correction:not(.proposed)');
        const cAddSection = sotd.querySelector('p.addition:not(.proposed)');
