...
exports.check = function (sr, done) {
    ...
    if (sotd) {
        ...
        var w3cMembership = 'https://www.w3.org/Consortium/Prospectus/Joining';
        var w3cPP =
            'https://www.w3.org/Consortium/Patent-Policy/#sec-submissions';
        var w3cSubm = 'https://www.w3.org/Submission';
        var foundW3Cprocess = false;
        var foundW3Cmembership = false;
        var foundPP = false;
        var foundSubm = false;
        var foundSubmMembers = false;
        var foundComment = false;
        st.querySelectorAll('a[href]').forEach(function (a) {
