...
function findSW(candidates, sr) {
    ...
    const INTRO_S =
        ' A Candidate Recommendation Snapshot has received wide review and is intended to gather implementation experience, and participants granted Royalty-Free IPR licenses for implementations.';
    const INTRO_D =
        ...
        if (sr.config.stabilityWarning === 'REC') {
            ...
            if (!sw) sr.error(self, 'no-stability');
                ...
                if (!review) sr.error(self, 'no-cr-review');
                    ...
                    review.href !==
                    'https://www.w3.org/2021/Process-20210915/#dfn-wide-review'
                )
