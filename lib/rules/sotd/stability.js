...
function findSW(candidates, sr) {
    ...
    var DRADT_STATEMENT = "This is a draft document and may be updated, replaced or obsoleted by other documents at any time.";
    var sw = null;
    ...
    ,   wanted = "^Publication as " + article + " " + sr.config.longStatus +
        represent + " does not imply endorsement by the W3C Membership. " + (crType ? CR_INTRO : DRADT_STATEMENT)
    ;
