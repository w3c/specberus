...
function findSW(candidates, sr) {
    ...
    ,   INTRO_D = " A Candidate Recommendation Draft is published to solicit review of intended changes from the previous Candidate Recommendation Snapshot."
    ...
    ,   wanted = "^Publication as " + article + " " + sr.config.longStatus +
        represent + " does not imply endorsement by the W3C Membership." + (crType ? CR_INTRO : "")
    ;
