...
function findSW(candidates, sr) {
    ...
    ,   INTRO_D = "A Candidate Recommendation Draft is published changes from the previous Candidate Recommendation that the Working Group intends to include in to solicit review of intended changes from the previous Candidate Recommendation Snapshot."
