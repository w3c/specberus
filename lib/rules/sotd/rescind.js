...
function findRscndRational ($candidates, sr) {
    ...
    $candidates.each(function () {
        var $p = sr.$(this)
        ,   text = sr.norm($p.text())
        ,   wanted1 = /W3C has chosen to rescind the .*? Recommendation for the following reasons:/
        ,   wanted2 = /For additional information about replacement or alternative technologies, please refer to the explanation of Obsoleting and Rescinding W3C Specifications./
        ;
