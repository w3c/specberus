...
function buildWanted(groups, sr, ppLink) {
    ...
    if (isRecTrack) {
        ...
        wanted = `The( 15 September 2020)? W3C Patent Policy does not carry any licensing requirements or commitments on this document.`;
    }
...
exports.check = async function (sr, done) {
    ...
    // for note-track and registry-track documents, use PP2020
    if (sr.config.track !== 'Recommendation') {
        patent = pp2020;
    }
