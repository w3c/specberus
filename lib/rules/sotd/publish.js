...
exports.check = function (sr, done) {
    ...
    var text =
        'This document was (?:produced|published) by the (.+? Working Group|Technical Architecture Group)( and the (.+? Working Group|Technical Architecture Group))? as a ' +
        docType +
        '.';
        ...
        Array.prototype.some.call(sotd.querySelectorAll('p'), (paragraph) => {
            ...
            if (txt.match(PUBLISH)) {
                ...
                if (recType.substantiveChanges || recType.newFeatures) {
                    ...
                    var proposedFound = Array.prototype.some.call(
