...
exports.check = function (sr, done) {
    ...
    if (sotd) {
        ...
        const proposedAdditionElement = sr.jsDocument.querySelector('.addition.proposed');
        const proposedCorrectionElement = sr.jsDocument.querySelector('.correction.proposed');
