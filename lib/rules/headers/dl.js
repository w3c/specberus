...
exports.check = function (sr, done) {
    ...
    if (dts.This) {
        ...
        if (!linkThis || linkThis.getAttribute("href").trim() !== linkThis.textContent.trim())
    ...
    if (dts.Latest) {
        ...
        if (!linkLate || linkLate.getAttribute("href").trim() !== linkLate.textContent.trim())
    ...
    if (dts.Previous) {
        ...
        if (!linkPrev || linkPrev.getAttribute("href").trim() !== linkPrev.textContent.trim())
    ...
    if (dts.Rescinds) {
        ...
        if (!linkResc || linkResc.getAttribute("href") !== linkResc.textContent) sr.error(self, "rescinds-link");
