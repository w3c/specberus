...
exports.check = function (sr, done) {
    ...
    if (dts.This) {
        ...
        if (!$linkThis || !$linkThis.length || !$linkThis.attr("href") || !$linkThis.text() || $linkThis.attr("href").trim() !== $linkThis.text().trim())
    ...
    if (dts.Latest) {
        ...
        if (!$linkLate || !$linkLate.length || !$linkLate.attr("href") || ! $linkLate.text() || $linkLate.attr("href").trim() !== $linkLate.text().trim())
    ...
    if (dts.Previous) {
        ...
        if (!$linkPrev || !$linkPrev.length || !$linkPrev.attr("href") || !$linkPrev.text() || $linkPrev.attr("href").trim() !== $linkPrev.text().trim())
