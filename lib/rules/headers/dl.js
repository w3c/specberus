...
exports.check = function (sr, done) {
    ...
    if (dts.This && dts.This.el && dts.This.dd && dts.This.el['0'] && dts.This.dd['0']) {
      sr.data.thisVersion = dts.This.el['0'] + ' ' + dts.This.dd['0'];
    }

    if (dts.Latest && dts.Latest.el && dts.Latest.dd && dts.Latest.el['0'] && dts.Latest.dd['0']) {
      sr.data.latestVersion = dts.Latest.el['0'] + ' ' + dts.Latest.dd['0'];
    }

    if (dts.Previous && dts.Previous.el && dts.Previous.dd && dts.Previous.el['0'] && dts.Previous.dd['0']) {
      sr.data.previousVersion = dts.Previous.el['0'] + ' ' + dts.Previous.dd['0'];
    }

    sr.data.latestVersion = dts.Latest || null;
    sr.data.previousVersion = dts.Previous || null;
