...
exports.check = function (sr, done) {
    ...
    if (dts.Latest) {
        ...
        if (!linkLate || !linkLate.length || linkLate.getAttribute("href").trim() !== linkLate.textContent.trim())
    ...
    if (dts.Previous) {
        ...
        if (!linkPrev || !linkPrev.length || linkPrev.getAttribute("href").trim() !== linkPrev.textContent.trim())
    ...
    if (dts.Rescinds) {
        ...
        if (!linkResc || !linkResc.length || linkResc.getAttribute("href") !== linkResc.textContent) sr.error(self, "rescinds-link");
