exports.messages = {
    ...
    'headers.secno.not-found':
        'Please consider wrapping section numbers (in the TOC and in headings) with <code>&lt;span class="secno"&gt;</code>.',
    // headers/h1-title
    ...
    'headers.dl.previous-not-needed':
        'Previous Version is included but does not seem necessary.',
    'headers.dl.this-latest-order':
        'This Version must be before Latest Version.',
    'headers.dl.latest-previous-order':
        'Latest Version must be before Previous Version.',
    ...
    'headers.dl.this-latest-shortname':
        '<em>Shortnames</em> differ between This and Latest Versions.',
    'headers.dl.latest-syntax': 'Wrong syntax for Latest Version link.',
    'headers.dl.previous-link':
        'Link href and text differ for Previous Version.',
    'headers.dl.this-previous-shortname':
        '<em>Shortnames</em> differ between This and Previous Versions.',
    'headers.dl.previous-syntax':
        'Wrong syntax for Previous Version link (perhaps not using HTTPS).',
    ...
    'headers.dl.rescinds-link':
        'Link href and text differ for Rescinds this Recommendation.',
    'headers.dl.this-rescinds-shortname':
        '<em>Shortnames</em> differ between This Version and Rescinds this Recommendation.',
    ...
    'headers.dl.obsoletes-link':
        'Link href and text differ for Obsoletes this Recommendation.',
    ...
    'headers.dl.supersedes-link':
        'Link href and text differ for Supersedes this Recommendation.',
    'headers.dl.this-supersedes-shortname':
        '<em>Shortnames</em> differ between This Version and Supersedes this Recommendation.',
    'headers.dl.supersedes-syntax':
        'Wrong syntax for Supersedes this Recommendation link.',
    'headers.dl.cant-retrieve':
        'Could not retrieve URI for previous version or for latest version.',
    'headers.dl.latest-is-not-previous':
        'Retrieved "previous" and "latest" documents, but their contents don\'t match.',
    'headers.dl.same-this-and-previous':
        '"This" version and "previous" version have the same URL.',
    'headers.dl.same-day-publication':
    ...
    'headers.errata.link-should-be-https':
        'Errata link should start with <em>https://</em>, current link is: `${link}`.',
    // headers/div-head
    ...
    'headers.copyright.link-text':
        "Missing link '${href}' with text '${text}'.",
    ...
    'links.compound.no-validation':
        'Validation of <a href="${link}">${file}</a> <a href="https://validator.w3.org/nu/doc=${link}">HTML</a> <a href="https://jigsaw.w3.org/css-validator/validator?profile=css3svg&uri=${link}">CSS</a>',
    'links.compound.link':
        'Validation of <a href="${link}">${file}</a> <a href="https://validator.w3.org/nu/doc=${link}">HTML ${markup}</a> <a href="https://jigsaw.w3.org/css-validator/validator?profile=css3svg&uri=${link}">CSS ${css}</a>',
    'links.compound.error':
        'Validation of <a href="${link}">${file}</a> <a href="https://validator.w3.org/nu/doc=${link}">HTML</a> <a href="https://jigsaw.w3.org/css-validator/validator?profile=css3svg&uri=${link}">CSS</a>: ${errMsg}',
    ...
    'links.reliability.unreliable-link':
        'Link for <em>"${text}"</em> is pointing to unreliable domain <em>"${link}"</em>.',
    // sotd/supersedable
    ...
    'sotd.submission.no-sm-link':
        "Missing link 'http://www.w3.org/Submission/...' with text 'Submitting Members'.",
    'sotd.submission.no-tc-link':
        "Missing link 'http://www.w3.org/Submission/...' with text 'W3C Team Comment'.",
    // sotd/stability
    ...
    'sotd.stability.wrong-cr-review-link':
        "Wrong wide review link for Candidate Recommendation, link should be 'https://www.w3.org/2020/Process-20200915/#dfn-wide-review'",
    // sotd/status
    ...
    'sotd.cr-end.multiple-found':
        'Multiple feedback due dates found. Choosing the closest date.',
    'sotd.cr-end.found-not-valid':
    ...
    'sotd.pp.expected-pp':
        'Expected text related to patent policy requirements: <blockquote>${expected}</blockquote>',
    'sotd.pp.no-errata':
    ...
    'sotd.rec-addition.no-addition':
        'This document contains new feature(s), cannot find corresponding paragraph <code>&lt;p class="addition"&gt;Proposed additions are marked in the document.&lt;/p&gt;</code>',
    'sotd.rec-addition.wrong-text':
        "The text in 'p.${type}' paragraph should be <code>${text}</code>",
    'sotd.rec-addition.unnecessary-correction':
        'This document doesn\'t contain substantive changes, paragraph <code>&lt;p class="correction"&gt;Proposed corrections are marked in the document.&lt;/p&gt;</code> should be removed.',
    'sotd.rec-addition.unnecessary-addition':
        'This document doesn\'t contain new features, paragraph <code>&lt;p class="addition"&gt;Proposed additions are marked in the document.&lt;/p&gt;</code> should be removed.',
    // sotd/publish
    ...
    // sotd/group-homepage
    'sotd.group-homepage.no-response':
        'The connection to the API failed: HTTP ${status}',
    'sotd.group-homepage.no-homepage':
    ...
    'sotd.new-features.no-link':
        'The paragraph on future updates to the recommendation should include a link to the new features: https://www.w3.org/2020/Process-20200915/#allow-new-features',
    ...
    'structure.display-only.special-box-markup':
        'Remember to use classes <code>example</code>, <code>def</code>, <code>note</code> and <code>marker</code>, and <a href="http://fantasai.inkedblade.net/style/design/w3c-restyle/2016/sample#boxes">other special box markup</a>.',
    'structure.display-only.index-list-tables':
        'Remember to use class <code>index</code> for <a href="http://fantasai.inkedblade.net/style/design/w3c-restyle/2016/sample#indexing">index lists and tables</a>.',
    ...
    'style.script.not-found':
        'A link to the script <code>fixup.js</code> is required (eg, <code>&lt;script src="//www.w3.org/scripts/TR/2016/fixup.js"&gt;&lt;/script&gt;</code>).',
    // style/back-to-top
    ...
    'validation.css.warning':
        '[${level}:${type}] ${message} (${source}, line ${line})<br><a href="${link}">CSS validator</a>',
    'validation.css.error':
        '[${type}] ${message} (${source}, line ${line} in “${context}”)<br><a href="${link}">CSS validator</a>',
    ...
    'validation.wcag.tools':
        "Please verify using <a href='http://www.w3.org/WAI/ER/existingtools.html'>Accessibility Evaluation and Repair Services</a>.",
    ...
    // Echidna
    'echidna.editor-ids.no-editor-id':
        'Editor IDs must be set for each editor, in the <code>data-editor-id</code> attribute.',
    ...
    'metadata.dl.previous-not-found':
        'Metadata extraction could not find the previous version link.',
