...
,   "headers.h2-status.bad-h2": "Incorrect status h2 header."
    // headers/h3-cr-type
,   "headers.h3-cr-type.not-found":  "Cannot find h3 element."
,   "headers.h3-cr-type.not-match": "The text of h3 element should be \"${txt}\"."
    // headers/h2-toc
...
,   "headers.mailing-list.no-sub":     "No mailing list subscription link."
...
,   "sotd.stability.no-cr-review-link": "No wide review link for Candidate Recommendation"
...
,   "sotd.cr-end.editorial":      "Skip review end date check for CR updates with editorial changes."
    // sotd/cr-end
,   "sotd.cr-stability.not-found":  "No stability paragraph found for CR Draft."
,   "sotd.cr-stability.two-found":  "Two stability paragraphs found for CR Draft, choose only one."
    // sotd/pp
...
,   "sotd.pp.no-deliverer":        "Unable to find the deliverer id"
,   "sotd.pp.charters":          "Error while fetching the charters of the Working Group: ${err}"
,   "sotd.pp.no-charter":        "No valid charter found"
...
,   "sotd.pp.no-response":       "The connection to the API failed: HTTP ${status}"
...
,   "sotd.rec-addition.wrong-text":     "The text in 'p.${type}' paragraph should be <code>${CORRECTION}</code>"
...
,   "sotd.publish.url-not-found": "Cannot find the link on \"${text}\" in publisher paragraph in Status of This Document. The right link is: <code>&lt;a href=\"${url}\"&gt;${text}&lt;/a&gt;</code>"
...
,   "sotd.deliverer-note.not-found": "Deliverer not found. An attribute <code>data-deliverer</code> must be in the SotD"
    // sotd/pr-upcoming-changes
,   "sotd.pr-upcoming-changes.no-link":    "The paragraph on future updates to the recommendation should include a link to the new features: https://www.w3.org/2020/Process-20200915/#allow-new-features"
,   "sotd.pr-upcoming-changes.no-warning": "<strong style='font-size: 20px;'>If it is the intention to incorporate new features in future updates of the Recommendation, please make sure to identify the document as intending to allow new features.</strong>"
    // structure/canonical
