...
,   "sotd.charter-disclosure.no-response":    "The connection to the API failed: HTTP ${status}"
    // sotd/rec-addition
,   "sotd.rec-addition.no-correction":  "This document contains substantive changes, cannot find currsponding paragraph <code>&lt;p class=\"correction\"&gt;Proposed corrections are marked in the document.&lt;/p&gt;</code>"
,   "sotd.rec-addition.no-addition":    "This document contains new feature, cannot find currsponding paragraph <code>&lt;p class=\"addition\"&gt;Proposed additions are marked in the document.&lt;/p&gt;</code>"
