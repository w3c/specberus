...
exports.messages = {
    ...
    'headers.copyright.no-data-from-API':
        "Could not get the document license from the API. Please make sure this group has a current charter, and it's mentioning at least one document license.",
    'headers.copyright.no-license-found-joint':
        "This document is published by multiple groups, but these groups doesn't agree on the same document license. Please ask the team contact for help.",
