...
exports.messages = {
    ...
    'sotd.usage.not-found':
        'Cannot found the paragraph regarding usage in the Status of This Document.',
    // sotd/submission
    ...
    'sotd.stability.no-rec-review':
        'No indication that the Recommendation is endorsed by the W3C and its Members.',
    ...
    'sotd.draft-stability.not-found':
        'No stability paragraph found. Expected one of the 2 following paragraphs: <blockquote>${expected1}<br>${expected2}</blockquote>',
    // sotd/pp
    'sotd.pp.no-pp':
