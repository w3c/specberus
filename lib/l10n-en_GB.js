...
,   'structure.display-only.fit-in-a4':                'Make sure spec illustrations/tables fit within an A4 sheet of paper when printed; use class <code>overlarge</code> if needed to improve experience on-screen for things that overflow.'
    // structure/neutral
,   "structure.neutral.neutral": 'Please make sure the expressions in document are neutral, "${words}" found in document. Check <a href="https://w3c.github.io/manual-of-style/">W3C Manual of Style</a> for more information, .'
    // style/sheet
