...
exports.messages = {
    ...
    'sotd.pp.joint-different-pp':
        'This document is published by multiple groups using different versions of Patent Policy. See requirement details at <a href="https://github.com/w3c/specberus/issues/1319#issuecomment-878619033">this GitHub Issue</a>.',
    'sotd.pp.wrong-pp-from-charter':
        'The Working Group delivering the document operates under the patent policy "${pp_charter}", but the check is against "${pp_config}". Please change the UI or query parameter to match the charter\'s version.',
    // sotd/charter
    'sotd.charter.no-group':
        'Unable to find the group id (in data-deliverer for Note-Track document, and in Status of This Document for REC-Track document).',
    ...
    'heuristic.shortname.error-request':
        'Request to ${shortlink} failed with error: ${error}',
    'heuristic.shortname.shortname-duplicate':
        "This document is a 'First Public' document, which cannot use an existing shortname '${shortname}', choose another shortname instead.",
    // Echidna
