...
export const messages = {
    ...
    'headers.copyright.exception-no-html':
        'This ${shortname} document uses a special copyright, but the HTML in this document does not match requirements. The HTML should match <blockquote class="boilerplate">${html}</blockquote>',
