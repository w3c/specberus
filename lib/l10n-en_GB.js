...
exports.messages = {
    ...
    'sotd.stability.wrong-cr-review-link':
        "Wrong wide review link for Candidate Recommendation, link should be 'https://www.w3.org/2021/Process-20210923/#dfn-wide-review'",
    // sotd/status
    ...
    'sotd.new-features.no-link':
        'The paragraph on future updates to the recommendation should include a link to the new features: https://www.w3.org/2021/Process-20210923/#allow-new-features',
    ...
    'heuristic.shortname.shortname-duplicate':
        "This document is a 'First Public' document (inferred by 404 response for 'History' link), which cannot use an existing shortname '${shortname}' (extracted from 'Latest published version'), choose another shortname instead.",
    // Echidna
