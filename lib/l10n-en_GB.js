...
,   "sotd.rec-addition.unnecessary-addition": "This document doesn't contain new features, paragraph <code>&lt;p class=\"addition\"&gt;Proposed additions are marked in the document.&lt;/p&gt;</code> should be removed."
    // sotd/publish
,   "sotd.publish.not-found": "Cannot find the publish paragraph in Status of This Document, introducing document type and publisher."
,   "sotd.publish.url-not-found": "Cannot find the link to \"${text}\" in publish paragraph in Status of This Document. The right link is: <code>&lt;a href=\"${url}\"&gt;${text}&lt;/a&gt;</code>"
,   "sotd.publish.url-not-match": "The link to \"${text}\" in publish paragraph in Status of This Document is not correct. The right link is: <code>&lt;a href=\"${url}\"&gt;${text}&lt;/a&gt;</code>"
