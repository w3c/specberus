...
exports.messages = {
    ...
    'headers.dl.history-404-none-FP':
        'This document is not a First Public document, but the history link "${url}" doesn\'t exist, if it\'s a shortname change situation, please make sure the lt;agt; link has a `data-previous-shortname` attribute.',
    ...
    'headers.dl.error-request':
        'Request error to "${url}" with error "${error}", please check your network or retry.',
