...
exports.messages = {
    ...
    'sotd.pp.wrong-pp-from-charter':
        'This document\'s charter uses patent policy "${pp_charter}", but the check is against "${pp_config}". Please change the UI or query parameter to match the charter\'s version.',
    // sotd/charter
