...
export const messages = {
    ...
    'headers.shortname.shortname-existed':
        'The ${status} should use an unique shortname.',
    ...
    'headers.dl.history-syntax':
        'Wrong syntax for History link, the link should start with "https://www.w3.org/standards/history/".',
