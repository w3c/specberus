...
,   "headers.dl.implelink-should-be-https": "Implementation report link should start with <em>https://</em>, Implementation report link in <code>&lt;dl&gt;</code> is: `${link}`."
    // headers/errata
,   "headers.errata.not-found":             "Errata paragraph not found."
,   "headers.errata.link-should-be-https":         "Errata link should start with <em>https://</em>, errata link in document is: `${link}`."
    // headers/div-head
...
,   "sotd.implementation.link-should-be-https": "implementation report link should start with <em>https://</em>, implementation report link in <em>Status of This Document</em> is: `${link}`."
    // sotd/ac-review
