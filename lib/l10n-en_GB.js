...
,   "headers.dl.this-link-not-found":       "Cannot find the &lt;a&gt; tag for This Version."
,   "headers.dl.this-link":                 "This Version: Link href and text differ. Link href is `${href}` while text is `${text}`."
...
,   "headers.dl.latest-link-not-found":      "Cannot find the &lt;a&gt; tag for Latest Version."
,   "headers.dl.latest-link":               "Latest Version: Link href and text differ. Link href is `${href}` while text is `${text}`."
,   "headers.dl.this-latest-shortname":     "<em>Shortnames</em> differ between This version (${thisShortname}) and Latest Versions (${latestShortname})."
,   "headers.dl.latest-syntax":             "Wrong syntax for Latest Version link."
,   "headers.dl.previous-link-not-found":              "Cannot find the &lt;a&gt; tag for Previous Version."
,   "headers.dl.previous-link":             "Previous Version: Link href and text differ. Link href is `${href}` while text is `${text}`."
,   "headers.dl.this-previous-shortname":   "<em>Shortnames</em> differ between This version (${thisShortname}) and Previous Versions (${previousShortname})."
...
,   "headers.dl.rescinds-link-not-found":   "Cannot find the &lt;a&gt; tag for Rescinds this Recommendation."
,   "headers.dl.rescinds-link":             "Rescinds this Recommendation: Link href and text differ. Link href is `${href}` while text is `${text}`."
,   "headers.dl.this-rescinds-shortname":   "<em>Shortnames</em> differ between This Version (${thisShortname}) and Rescinds this Recommendation (${rescindsShortname})."
...
,   "headers.dl.implelink-not-found": "No implementation report link found."
...
,   "headers.dl.editor-missing-id": "Missing `data-editor-id` attribute for editor(s): ${names}."
    // headers/errata
...
,   "headers.mailing-list.no-list":    "No mailing list link."
,   "headers.mailing-list.no-arch":    "No mailing list archives link."
,   "headers.mailing-list.no-repo":    "No GitHub repository issue link. The link is expected to be of the form <code>https://github.com/&lt;USER_OR_ORG&gt;/&lt;REPO_NAME&gt;/issues[/&hellip;]</code>."
    // links/internal
...
,   "sotd.stability.no-rec-review": "No indication that the Recommendation has received the endorsement of the W3C and its Members."
,   "sotd.stability.no-cr-review": "No wide review link for Candidate Recommendation"
,   "sotd.stability.wrong-cr-review-link": "Wrong wide review link for Candidate Recommendation, link should be 'https://www.w3.org/2020/Process-20200915/#dfn-wide-review'"
    // sotd/status
...
,   "sotd.cr-end.found-not-valid": "Feedback due date detected: ${date}, but not valid: minimum review period is 28 days after publication."
...
,   "sotd.pp.undefined":         "Couldn't not determine the patent policy the WG is operating under. Check the WG's charter."
,   "sotd.pp.no-pp2017":         "The WG is operating under the patent policy 2017 but the document mentions a different one"
,   "sotd.pp.no-pp2020":         "The WG is operating under the patent policy 2020 but the document mentions a different one"
...
,   "sotd.pp.no-claims":         "No valid HTTPS link to definition of essential claims (<code>${link}</code>)."
,   "sotd.pp.no-section6":       "No valid HTTPS link to the Disclosure section of the patent policy (<code>${link}</code>)."
...
,   "sotd.rec-addition.no-addition":    "This document contains new feature(s), cannot find corresponding paragraph <code>&lt;p class=\"addition\"&gt;Proposed additions are marked in the document.&lt;/p&gt;</code>"
,   "sotd.rec-addition.wrong-text":     "The text in 'p.${type}' paragraph should be <code>${text}</code>"
,   "sotd.rec-addition.unnecessary-correction": "This document doesn't contain substantive changes, paragraph <code>&lt;p class=\"correction\"&gt;Proposed corrections are marked in the document.&lt;/p&gt;</code> should be removed."
,   "sotd.rec-addition.unnecessary-addition": "This document doesn't contain new features, paragraph <code>&lt;p class=\"addition\"&gt;Proposed additions are marked in the document.&lt;/p&gt;</code> should be removed."
    // sotd/publish
,   "sotd.publish.not-found":     "Cannot find the paragraph introducing document type and publisher in Status of This Document."
,   "sotd.publish.url-text-not-found": "Cannot find text \"${text}\" in publisher paragraph in Status of This Document. The right link is: <code>&lt;a href=\"${url}\"&gt;${text}&lt;/a&gt;</code>"
,   "sotd.publish.url-not-match": "The link for \"${text}\" in publisher paragraph in the Status of This Document is not correct. The right link is: <code>&lt;a href=\"${url}\"&gt;${text}&lt;/a&gt;</code>"
    // sotd/rec-comment-end
,   "sotd.rec-comment-end.not-found": "This W3C Recommendation has substantive changes or new features, cannot find comment end date no earlier than ${minimumEndDate}."
,   "sotd.rec-comment-end.multi-found": "This W3C Recommendation has substantive changes or new features, multiple dates no earlier than ${minimumEndDate} were found: ${date}."
    // sotd/group-homepage
...
,   "sotd.deliverer-note.not-found": "Deliverer not found. An attribute <code>data-deliverer</code> must be in the SotD"
    // sotd/new-features
,   "sotd.new-features.no-link":    "The paragraph on future updates to the recommendation should include a link to the new features: https://www.w3.org/2020/Process-20200915/#allow-new-features"
,   "sotd.new-features.no-warning": "<strong style='font-size: 20px;'>If it is the intention to incorporate new features in future updates of the Recommendation, please make sure to identify the document as intending to allow new features.</strong>"
    // structure/canonical
