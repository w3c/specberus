...
,   "links.compound.no-validation":     "Validation of <a href=\"${link}\">${file}</a> <a href=\"http://validator.w3.org/nu/doc=${link}\">HTML</a> <a href=\"http://jigsaw.w3.org/css-validator/validator?profile=css3&uri=${link}\">CSS</a>"
,   "links.compound.link":              "Validation of <a href=\"${link}\">${file}</a> <a href=\"http://validator.w3.org/nu/doc=${link}\">HTML ${markup}</a> <a href=\"http://jigsaw.w3.org/css-validator/validator?profile=css3&uri=${link}\">CSS ${css}</a>"
,   "links.compound.error":             "Validation of <a href=\"${link}\">${file}</a> <a href=\"http://validator.w3.org/nu/doc=${link}\">HTML</a> <a href=\"http://jigsaw.w3.org/css-validator/validator?profile=css3&uri=${link}\">CSS</a>: ${errMsg}"
