/**
 * Main file of the Spartacus npm package.
 *
...
var Spartacus = function () {
    this.version = version;
    this.clearCache();
};

Spartacus.prototype.clearCache = function () {
    this.docDate = null;
    this.docDateEl = null;
...
Spartacus.prototype.extractMetadata = function (options) {
...
Spartacus.prototype.validate = function (options) {
...
Spartacus.prototype.error = function (rule, key, extra) {
    var name;
...
Spartacus.prototype.warning = function (rule, key, extra) {
    this.sink.emit('warning', rule, { key: key, extra: extra });
};

Spartacus.prototype.info = function (rule, key, extra) {
    this.sink.emit('info', rule, {key: key, extra: extra});
};

Spartacus.prototype.metadata = function (key, value) {
...
Spartacus.prototype.throw = function (msg) {
    console.error('[EXCEPTION] ' + msg); // eslint-disable-line no-console
    this.sink.emit('exception', { message: msg });
};

Spartacus.prototype.checkSelector = function (sel, name, done) {
    try {
...
Spartacus.prototype.norm = function (str) {
    if (!str) return "";
    str = "" + str;
...
Spartacus.prototype.dateRegexStrCapturing = "(\\d?\\d) (" + months.join("|") + ") (\\d{4})";
Spartacus.prototype.dateRegexStrNonCapturing = "\\d?\\d (?:" + months.join("|") + ") \\d{4}";

Spartacus.prototype.stringToDate = function (str) {
...
Spartacus.prototype.getDocumentDate = function () {
...
Spartacus.prototype.getDocumentDateElement = function () {
    if (this.docDateEl) return this.docDateEl;
    this.getDocumentDate();
    return this.docDateEl;
};

Spartacus.prototype.getSotDSection = function () {
...
Spartacus.prototype.extractHeaders = function ($dl) {
  var $ = this.$
  ,   self = this
  ,   dts = {}
  ,   EDITORS = /^editor(s)?$/
...
Spartacus.prototype.getEditorIDs = function () {
    var $ = this.$
...
Spartacus.prototype.getFeedbackDueDate = function() {
...
Spartacus.prototype.getDelivererIDs = function () {
...
Spartacus.prototype.getDelivererIDsNote = function() {
    var ids = []
    ,   $    = this.$
    ,   self = this
    ,   $sotd = self.getSotDSection()
...
Spartacus.prototype.loadURL = function (url, cb) {
...
Spartacus.prototype.loadSource = function (src, cb) {
...
Spartacus.prototype.loadFile = function (file, cb) {
...
Spartacus.prototype.loadDocument = function (doc, cb) {
...
Spartacus.prototype.transition = function (options) {
