...
(function (global) {
    ...
    Specberus.prototype.validate = function (options) {
        ...
        if (options.skipValidation) self.config.skipValidation = true;
        if (options.noRecTrack) self.config.noRecTrack = true;
        if (options.informativeOnly) self.config.informativeOnly = true;
        self.sink = sink;
        var seenErrors = {};
