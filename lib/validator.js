...
Specberus.prototype.getRecMetadata = function (sotdText, meta) {
    if (sotdText.match(/It includes proposed correction(s)\.|substantive change(s)?/))
        meta.substantiveChanges = true;
    if (sotdText.match(/new feature(s)?/))
