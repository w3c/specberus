...
import { assembleData, setLanguage } from './l10n';
import * as profileMetadata from './profiles/metadata';
import { get } from './throttled-ua';
import {
    AB,
    buildJSONresult,
    nextUntil,
...
Specberus.prototype.validate = function (options) {
    ...
    try {
        self.config = processParams(options, profile.config);
    } catch (err) {
