...
,   headers:   {
    ...
    ,   dl:  [
        ...
        ,   { doc: "headers/dl-mismatch.html", config: { status: "REC" }
            , errors: ["headers.dl.link-diff", "headers.dl.this-syntax", "headers.dl.link-diff", "headers.dl.latest-syntax", "headers.dl.link-diff", "headers.dl.previous-syntax", "headers.dl.implelink-not-found", "headers.dl.editor-not-found"]
