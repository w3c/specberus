...
const compareMetadata = function (url, file, expectedObject) {
    const specberus = new validator.Specberus(),
        handler = new sink.Sink(function (data) {
...
var tests = {
    ...
    echidna: {
        'editor-ids': [
            ...
            {
                doc: 'echidna/fails-missing-editorsid.html',
                errors: ['echidna.editor-ids.no-editor-id'],
            },
        ],
        'todays-date': [
            {
        ...
        dl: [
            ...
            },
            {
                ...
                errors: [
                    ...
                    'headers.dl.implelink-not-found',
                ],
            },
            {
                doc: 'headers/fails.html',
            ...
            },
            {
                ...
                config: { status: 'REC' },
                errors: [
                    'headers.dl.this-link',
                    'headers.dl.this-syntax',
                    'headers.dl.latest-link',
    ...
    sotd: {
        ...
        pp: [
            ...
            {
                doc: 'sotd/joint-publication.html',
                config: { recTrackStatus: true, patentPolicy: 'pp2004' },
                errors: ['sotd.pp.no-pp'],
