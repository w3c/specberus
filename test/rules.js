...
//     ,
    ...
    //     ,
        ...
        //  // WG-Note (Non FP), checked a WG-Note (with previous version)
        //     ,
            { doc: "online/WG-NOTE-lpf.html", config: { longStatus: "Working Group Note" } }
            // WG-Note (Non FP), checked as FPWG-Note
        ,   { doc: "online/WG-NOTE-lpf.html", config: { longStatus: "Working Group Note", previousVersion: false }, warnings: ["headers.dl"] }
            // FPWG-Note, checked as FPWG-Note, 
        ,   { doc: "online/WG-NOTE-lpf.html", config: { longStatus: "Working Group Note", previousVersion: false } },
            // FPWG-Note, checked as WG-Note(not FP, prev version required),
        ,   { doc: "online/WG-NOTE-lpf.html", config: { longStatus: "Working Group Note", previousVersion: true}, errors: ["headers.dl"] }
